          ...
          <div className="container mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 flex items-center justify-center rounded-full bg-green-100 text-[#1dbf78] mb-6">
                ...
                <p className="mt-3 text-gray-600">
                  Set up a workspace for your business and manage your agents in
                  one place.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-3 text-gray-600">
                  Define your AI agent’s role, tone, and behavior to match your
                  brand.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-3 text-gray-600">
                  Copy the widget code and embed it on your website to start
                  chatting instantly.
                </p>
              </div>
            </div>
